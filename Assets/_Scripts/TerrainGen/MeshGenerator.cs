...
{
    public const int supportedLODs = 5;
    public const int supportedChunkSizesLength = 9;
    public const int supportedFlatshadedChunkSizesLength = 3;
        ...
        int levelOfDetail, bool useFlatShading)
    {
        ...
        var meshData = new MeshData(verteciesPerLine, useFlatShading);
...
public class MeshData
{
    ...
    void FlatShading()
    {
        ...
        {
            flatShaderVertices[i] = verticies[triangles[i]];
            flatShadedUVs[i] = uvs[triangles[i]];
            triangles[i] = i;
        }

        verticies = flatShaderVertices;
        uvs = flatShadedUVs;
    }
